    ...
    .config(function ($routeProvider)
    {
        ...
        $routeProvider
           ...
           .when('/home/profile',
            ...
            .when('/home',
            {
                templateUrl: baseURL + '/partials/home/home.php',
           ...
           .when('/docs/statementofaccts',
              ...
              .when('/shared/error',
            {
               ...
               .when('/admin/userlog',
            {
                templateUrl: baseURL + '/partials/admin/userlog.php',
             ...
             .when('/admin/PaymentLog',
            {
                ...
                templateUrl: baseURL +  '/partials/admin/Paymentlog.php',
                controller: 'paymentlogController'
            })
            .when('/admin/SchedPayments',
            {

                templateUrl: baseURL + '/partials/admin/SchedPayments.php',
                controller: 'schedpaymentsController'
            })
             .when('/admin/ApproveProfile',
            {

                templateUrl: baseURL + '/partials/admin/ApproveProfile.php',
                controller: 'approveprofileController'
            })
             .when('/admin/Approve',
            {

                templateUrl: baseURL + '/partial/admin/ApproveProfile.php',
                controller: 'approveprofileController'
            })
